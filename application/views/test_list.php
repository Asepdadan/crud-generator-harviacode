...
<html>
    ...
    <body>
	    ...
	    <tbody>
			...
			<?php 
			echo anchor(site_url('test/read/'.$test->idte),'Read'); 
			echo ' | '; 
			echo anchor(site_url('test/update/'.$test->idte),'Update'); 
			echo ' | '; 
			echo anchor(site_url('test/delete/'.$test->idte),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
			?>
		    </td>
	        </tr>
                <?php
